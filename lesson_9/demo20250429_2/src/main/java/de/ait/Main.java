...
public class Main {
    public static void main(String[] args) throws URISyntaxException {
        ...
        ResponseEntity<ArrayList<PostDto>> responseList = restTemplate.exchange(request, new ParameterizedTypeReference<ArrayList<PostDto>>() {
        });

      //  System.out.println("Статус код" + response.getBody());
      //  System.out.println("Заголовки" + response.getHeaders());

        //PostDto[] body = response.getBody();
        ArrayList<PostDto> body = responseList.getBody();
