...
//Ваша задача: используя эндпоинт /convert написать сервис конвертор валют. Т.е. пользователь вводит исходную валюту, сумму и валюту в которой необходим результат, программа выдает результат.
//
//
